                    ...
                    <div class="carousel-inner">
                        ...
                        <img class="d-block w-100" src="assets/images/slide1.jpg" alt="First slide">
                            <div class="carousel-caption">
                                <h3>JDA</h3>
                                <p>La mejor web de valoración de cervezas</p>
                            </div>
                        </div>
                        <div class="carousel-item">
                        <img class="d-block w-100" src="assets/images/slide2.jpg"" alt="Second slide">
                            <div class="carousel-caption">
                                <h3>Valora tus cervezas favoritas</h3>
                        ...
                        <img class="d-block w-100" src="assets/images/slide3.jpg"" alt="Third slide">
                            <div class="carousel-caption">
                                <h3>Descubre nuevas marcas</h3>
                                <p>Sabemos que eres un amante de la cerveza y que te encantará descubrir nuevos sabores.</p>
                            </div>
                        </div>
                    </div>
