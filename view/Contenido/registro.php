        ...
        <script>
			...
			<form id="frm" name="frm"  onsubmit="return validar(this)" action="?c=Web&a=Guardar_usuarios" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="password"  value="<?php echo $user->password_usuario; ?>" class="form-control" id= "password_usuario" name="password_usuario" placeholder="Contraseña" data-validacion-tipo="requerido|min:3" style="text-align: center">
                </div>
                <div class="form-group">
                    <label>Repite Password</label>
                    <input type="password" class="form-control" id="password2" name="password2" placeholder="Repite la contraseña" data-validacion-tipo="requerido|min:3" style="text-align: center">
                </div><hr/>
