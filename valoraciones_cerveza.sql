...
INSERT INTO `productos` VALUES (1,1,'Heineken','Cerveza de tipo Lager y estilo Pilsen de color amarillo claro y brillante, con una espuma blanca intensa, cremosa y persistente en el vaso. ','',2,5,2.50,'assets/images/heineken.png'),(2,1,'Carlsberg','Bien proporcionada, con sabor a lúpulo, grano de trigo, pino, acedera y manzanas de verano danesas.','',3,24,8.00,NULL),(3,1,'Foster','Cerveza extremadamente ligera, sin cuerpo, con demasiado carbónico y con un sabor que a duras penas pasa por el dulzor de la malta antes de llegar al amargor suave del lúpulo','',1,15,15.00,NULL),(4,2,'Warsteiner','Ligera y de suave carbonatación, donde detectar gran presencia de la malta y acabado con cierto amargor.','',2,8,4.00,NULL),(5,2,'Bitburger ',' Se aprecia en la copa que el carbónico es grueso y abundante, dando cierto punto de refresco al conjunto','',0,0,0.00,NULL),(6,2,'Beck\'s','Cerveza con poca espuma, muy blanca, y que dura muy poco en la copa. El color es amarillo pálido, con poca burbuja y bastante grande, con un cuerpo ligero','',1,8,8.00,NULL),(7,3,'Citra Cascade','Tiene un nivel de amargor moderado, y resulta ideal para hacer prácticas como el dry-hopping o el hopback','',0,0,0.00,NULL),(8,3,'Ambar IPA','Con 45 ibus, y 5,7 grados de alcohol, nuestro homenaje a este estilo icónico de la cervecería es una propuesta de amargor tolerable que destaca por la complejidad de sabores y aromas donde predominan las notas florales, cítricas y a frutas tropicales','',0,0,0.00,NULL),(9,3,'Moritz BaPA','Aromática, sedosa y muy fácil de beber. Elaborada con levadura de alta fermentación con un perfil muy afrutado, una mezcla de malta de cebada, malta de trigo y copos de avena','',0,0,0.00,NULL);
...
-- Dump completed on 2019-04-21  8:23:03
